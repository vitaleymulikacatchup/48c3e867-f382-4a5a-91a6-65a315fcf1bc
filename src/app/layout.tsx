...
export const metadata: Metadata = {
  title: "Bean Bliss - Artisan Coffee, Perfect Every Time",
  description: "Experience exceptional coffee with Bean Bliss. Freshly roasted beans, expert baristas, and sustainable sourcing. Order online or visit our coffee shop.",
  keywords: "coffee shop, artisan coffee, fresh roasted beans, coffee subscription, specialty coffee, barista, sustainable coffee",
  metadataBase: new URL("https://beanbliss.com"),
  alternates: {
    canonical: "https://beanbliss.com"
  },
  openGraph: {
    title: "Bean Bliss - Artisan Coffee, Perfect Every Time",
    description: "Experience exceptional coffee with Bean Bliss. Freshly roasted beans, expert baristas, and sustainable sourcing.",
    siteName: "Bean Bliss",
    url: "https://beanbliss.com",
    images: [{
      url: "https://images.pexels.com/photos/5198144/pexels-photo-5198144.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Bean Bliss coffee shop interior"
    }],
    type: "website"
  },
  twitter: {
